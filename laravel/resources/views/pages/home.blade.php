...
@section('content')
            ...
            <div id="carousel-id" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="{{ asset('site/img/slider/slide-1.jpg') }}" class="img-responsive desktop"
                            alt="Slide 1">
                        <img src="{{ asset('site/img/slider/slide-1-mobile.jpg') }}" class="img-responsive mobile"
                            alt="Slide 1">
                    </div>
                    <div class="item">
                        <img src="{{ asset('site/img/slider/slide-2.jpg') }}" class="img-responsive desktop"
                            alt="Slide 2">
                        <img src="{{ asset('site/img/slider/slide-2-mobile.jpg') }}" class="img-responsive mobile"
                            alt="Slide 2">
                    </div>
                    <div class="item">
                        <img src="{{ asset('site/img/slider/slide-3.jpg') }}" class="img-responsive desktop"
                            alt="Slide 3">
                        <img src="{{ asset('site/img/slider/slide-3-mobile.jpg') }}" class="img-responsive mobile"
                            alt="Slide 3">
                    </div>
                    <div class="item">
                        <img src="{{ asset('site/img/slider/slide-4.jpg') }}" class="img-responsive desktop"
                            alt="Slide 4">
                        <img src="{{ asset('site/img/slider/slide-4-mobile.jpg') }}" class="img-responsive mobile"
                            alt="Slide 4">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="content-area">
                        ...
                        <p>Foreign Office Employees Cooperative Housing Society (FOECHS) was registered with the Cooperative
                            Societies Department, Islamabad Capital Territory on 11 November 1984. The revised layout plan
                            has been approved by RDA and No Objection Certificates (NOCs) obtained from all the concerned
                            departments. </p>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-4 col-md-4 col-lg-3">
                    <div class="item">
                        <img src="{{ asset('site/img/icons/electricity.png') }}" class="img-responsive"
                            alt="electricity">
                        <h4>Electricity</h4>
                    </div>
                </div>
    ...
    <div class="section home-tenders">
        <div class="container">
            ...
            <p class="text-center">Browse through the tenders & procurements published in the newspapers for the
                development.</p>
                    ...
                    @foreach ($tenders as $tender)
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <a href="{{ route('single-tender', $tender->id) }}">
                                <div class="item">
                                    <img src="{{ asset('uploads/tenders/' . $tender->path) }}" class="img-responsive"
                                        alt="{{ $tender->title }}">
                                    <p><i class="fa fa-calendar"></i> {{ $tender->opening_date->format('d-m-Y') }} -
                                        <span style="color: #f00;">{{ $tender->closing_date->format('d-m-Y') }}</span>
                                    </p>
                                    <h3>{{ $tender->title }}</h3>
                                </div>
                            </a>
    ...
    <div class="section home-contact">
        <div class="container">
            <iframe src="{{ $settings['map_iframe'] }}" allowfullscreen="" loading="lazy"></iframe>
        </div>
    </div>
