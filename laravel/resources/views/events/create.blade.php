...
<div class="back-area mb-3">
    <a href="{{ route('events.index') }}" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left mr-2"></i> Go Back</a>
</div>
    ...
    <form action="{{ route('events.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control datetimepicker-input datepicker" name="schedule_date" data-toggle="datetimepicker" data-target=".datepicker"/>
            </div>
            @error('title')
            ...
            <div class="form-group">
                <label for="exampleInputFile">Event Banner</label>
